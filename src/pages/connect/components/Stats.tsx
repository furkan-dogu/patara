          ...
          <div className="flex items-center justify-between flex-wrap gap-3 w-full">
            <div className="flex items-center gap-3.5">
              ...
              <div className="flex flex-col gap-2">
                <p className="font-normal sm:text-sm sm:leading-[18px] text-xs text-[#808080]">{item.title}</p>
                <p className="font-medium sm:text-2xl sm:leading-7 text-xl text-white">{item.amount}</p>
              </div>
            </div>
            {item.claimBtn && (
